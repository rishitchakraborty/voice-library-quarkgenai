...
const SEED_CLIPS: AudioClip[] = [
  ...
  {
    id: 'seed-clip-5',
    title: 'Prime AI & Technology News Bulletin',
    promptText:
      'नमस्कार, मुख्य समाचारों में आपका स्वागत है। आज के विशेष बुलेटिन में हम आपको डिजिटल नवाचार और आर्टिफिशियल इंटेलिजेंस की ताज़ा जानकारियाँ देंगे।',
    voiceName: 'anchor',
    language: 'hi',
    speed: 1.05,
    duration: 8.9,
    createdAt: new Date(Date.now() - 1000 * 60 * 70).toISOString(),
    tags: ['#NewsBroadcast', '#Hindi', '#Anchor', '#PrimeNews'],
    peaks: generateSyntheticWaveform(64, 142),
    isFavorite: true,
    type: 'tts',
    cloudSynced: true,
  ...
  {
    id: 'seed-clip-6',
    title: 'Regional Banking Verification Link',
    promptText:
    ...
    tags: ['#RegionalLanguages', '#Marathi', '#IVR', '#Puja'],
    peaks: generateSyntheticWaveform(64, 168),
    isFavorite: false,
    type: 'tts',
    cloudSynced: true,
  ...
  {
    id: 'seed-clip-7',
    title: 'Global International Concierge',
    promptText:
    ...
    tags: ['#GlobalAccents', '#USEnglish', '#CustomerSupport', '#Marry'],
    peaks: generateSyntheticWaveform(64, 185),
    isFavorite: true,
    type: 'tts',
    cloudSynced: true,
